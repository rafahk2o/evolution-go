(function () {
  ...
  var css = ""
    ...
    + ".cw-action-bar{display:flex!important;align-items:stretch!important;overflow:hidden!important;}"
    + ".cw-action-bar>button{padding-left:8px!important;padding-right:8px!important;}"
    + ".cw-action-bar>button.flex-1{flex:1 1 116px!important;min-width:116px!important;max-width:none!important;overflow:hidden!important;white-space:nowrap!important;text-overflow:ellipsis!important;padding:0 8px!important;}"
    + ".cw-action-bar>button:not(.flex-1){flex:0 0 38px!important;width:38px!important;padding-left:0!important;padding-right:0!important;}"
    ...
    + ".cw-action-button{display:inline-flex;align-items:center;justify-content:center;width:38px;height:48px;padding:0;border:0;background:transparent;color:#1f93ff;cursor:pointer;border-radius:0;line-height:1;transition:background .15s ease;flex:0 0 38px!important;}"
